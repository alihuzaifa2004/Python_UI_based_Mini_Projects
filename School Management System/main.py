...
def login_user():
    ...
    role = role_var.get()  # get selected role from dropdown

    user = auth.login(username, password, role)  # ✅ Pass role too
    if user:
...
label_heading = tk.Label(root, text="School Management System", font=("Arial", 18, "bold"))
