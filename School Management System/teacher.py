...
def launch(username):
    teacher_root = tk.Tk()
    teacher_root.title("Teacher Dashboard")
    teacher_root.geometry("350x300")
    teacher_root.resizable(True, True)
    label_heading = tk.Label(teacher_root, text="Teacher Dashboard", font=("Arial", 18, "bold"))
